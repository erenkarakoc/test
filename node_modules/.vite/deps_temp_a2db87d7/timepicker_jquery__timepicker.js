...
var require_jquery_timepicker = __commonJS({
  "node_modules/timepicker/jquery.timepicker.js"(exports, module) {
    (function() {
      "use strict";
      ...
      var roundingFunction = function roundingFunction2(seconds, settings) {
        if (seconds === null) {
          return null;
        }
        var i = 0;
      ...
      var Timepicker = function() {
        ...
        _createClass(Timepicker2, [{
          ...
          value: function hideMe() {
            ...
            if (!this.list || !Timepicker2.isVisible(this.list)) {
              return;
            }
          ...
          value: function time2int(timeString) {
            if (timeString === "" || timeString === null || timeString === void 0) {
              return null;
            }
            if (timeString === "now") {
              return this.anytime2int(/* @__PURE__ */ new Date());
            }
          ...
          value: function parseSettings(settings) {
            settings.lang = _objectSpread2(_objectSpread2({}, DEFAULT_LANG), settings.lang);
          ...
          value: function _isTimeRangeError(seconds, settings) {
            ...
            var _iterator = _createForOfIteratorHelper(settings.disableTimeRanges), _step;
            try {
          ...
          value: function _handleKeyUp(e) {
            var _this2 = this;
            if (!this.list || !Timepicker2.isVisible(this.list) || this.settings.disableTextInput) {
              return true;
            }
          ...
          value: function hideAll() {
            var _iterator3 = _createForOfIteratorHelper(document.getElementsByClassName("ui-timepicker-input")), _step3;
            try {
      ...
      function renderHtml(tp) {
        ...
        if (tp.settings.className) {
          var _iterator4 = _createForOfIteratorHelper(tp.settings.className.split(" ")), _step4;
          try {
      ...
      (function(factory) {
        ...
        var methods = {
          ...
          show: function show(e) {
            ...
            } else if (self.offset().top + self.outerHeight(true) + list.outerHeight() > $2(window).height() + $2(window).scrollTop()) {
              verticalOrientation = "t";
            } else {
              verticalOrientation = "b";
            }
            ...
            if (!selected.length) {
              ...
              if (timeInt !== null) {
                selected = $2(tp._findRow(timeInt));
              } else if (settings.scrollDefault()) {
                selected = $2(tp._findRow(settings.scrollDefault()));
              }
            }
            ...
            if (settings.stopScrollPropagation) {
              $2(document).on("wheel.ui-timepicker", ".ui-timepicker-wrapper", function(e2) {
                e2.preventDefault();
                var currentScroll = $2(this).scrollTop();
                $2(this).scrollTop(currentScroll + e2.originalEvent.deltaY);
              });
            }
            $2(document).on("mousedown.ui-timepicker", _closeHandler);
            window.addEventListener("resize", _closeHandler);
            if (settings.closeOnScroll) {
              $2(settings.closeOnScroll).on("scroll.ui-timepicker", _closeHandler);
            }
          ...
          option: function option(key, value) {
            ...
            return this.each(function() {
              var self = $2(this);
              var tp2 = self[0].timepickerObj;
              var settings = tp2.settings;
              var list = tp2.list;
              if (_typeof(key) == "object") {
                settings = $2.extend(settings, key);
              } else if (typeof key == "string") {
                settings[key] = value;
              }
              settings = tp2.parseSettings(settings);
              tp2.settings = settings;
              tp2._formatValue({
                type: "change"
              }, "initial");
              if (list) {
          ...
          getTime: function getTime(relative_date) {
            ...
            if (!relative_date) {
              relative_date = /* @__PURE__ */ new Date();
            }
        ...
        function _render(self) {
          ...
          var wrapped_list = $2(renderHtml(tp));
          if (settings.useSelect) {
            list = wrapped_list;
          } else {
          ...
          if (settings.useSelect) {
            ...
            list.on("focus", function() {
              $2(this).data("timepicker-input").trigger("showTimepicker");
            });
            list.on("blur", function() {
              $2(this).data("timepicker-input").trigger("hideTimepicker");
            });
            list.on("change", function() {
              tp._setTimeValue($2(this).val(), "select");
            });
            ...
            list.on("mousedown click", "li", function(e) {
              ...
              list.find("li").removeClass("ui-timepicker-selected");
              $2(this).addClass("ui-timepicker-selected");
              if (tp._selectValue()) {
                self.trigger("hideTimepicker");
                list.on("mouseup.timepicker click.timepicker", "li", function(e2) {
        ...
        function _closeHandler(e) {
          ...
          Timepicker.hideAll();
          $2(document).off(".ui-timepicker");
          $2(window).off(".ui-timepicker");
        }
        ...
        $2.fn.timepicker = function(method) {
          if (!this.length)
            return this;
          if (methods[method]) {
            ...
            $2.error("Method " + method + " does not exist on jQuery.timepicker");
          }
        };
        $2.fn.timepicker.defaults = DEFAULT_SETTINGS;
      });
    })();
  }
});
export default require_jquery_timepicker();
...
timepicker/jquery.timepicker.js:
   ...
   *)
*/
//# sourceMappingURL=timepicker_jquery__timepicker.js.map
