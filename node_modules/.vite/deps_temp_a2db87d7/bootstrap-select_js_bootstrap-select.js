...
(function($) {
  ...
  function toKebabCase(str) {
    return str.replace(/[A-Z]+(?![a-z])|[A-Z]/g, function($2, ofs) {
      return (ofs ? "-" : "") + $2.toLowerCase();
    });
  }
  ...
  function getSelectValues(selectedOptions) {
    ...
    for (var i = 0, len = options.length; i < len; i++) {
      opt = options[i];
      if (!opt.disabled) {
        value.push(opt.value === void 0 ? opt.text : opt.value);
      }
    }
    if (!this.multiple) {
  ...
  function getVersion() {
    var version2;
    try {
      version2 = $.fn.dropdown.Constructor.VERSION;
    } catch (err) {
...
//# sourceMappingURL=bootstrap-select_js_bootstrap-select.js.map
