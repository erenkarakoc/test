...
(function($) {
  ...
  function RateYo($node, options) {
    ...
    function setRating(newValue) {
      ...
      showRating();
      if (isInitialized) {
        $node.trigger("rateyo.set", { rating });
      }
      return $node;
    }
    ...
    function onMouseEnter(e) {
      ...
      showRating(rating);
      $node.trigger("rateyo.change", { rating });
    }
  ...
  function deleteInstance(node, collection) {
    $.each(collection, function(index) {
      if (node === this.node) {
        var firstPart = collection.slice(0, index), secondPart = collection.slice(index + 1, collection.length);
  ...
  function _rateYo(options) {
    ...
    return $.each($nodes, function() {
      ...
      var $node = $(this), dataAttrs = {}, optionsCopy = $.extend({}, options);
...
//# sourceMappingURL=rateyo_src_jquery__rateyo.js.map
