...
class SeedStrategyPacks extends Command
{
    ...
    public function handle()
    {
        StrategyPacks::Create([
            ...
            'algorithms' => json_encode(['NSA', 'AR', 'HFT', 'SC', 'LM', 'SLTP', 'PT', 'MT', 'MAC', 'MACD']),
        ...
        StrategyPacks::Create([
            ...
            'algorithms' => json_encode(['NSA', 'AR', 'HFT', 'SC', 'LM', 'SLTP', 'PT', 'BT', 'FR', 'MM', 'GT', 'VWAP', 'TWAP']),
        ...
        StrategyPacks::Create([
            ...
            'algorithms' => json_encode(['NSA', 'AR', 'HFT', 'SC', 'LM', 'SLTP', 'PT', 'MM', 'VWAP', 'TWAP', 'NNP', 'MVO']),
