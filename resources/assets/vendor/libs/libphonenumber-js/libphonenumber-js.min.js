!(function (d, t) {
  'object' == typeof exports && 'object' == typeof module
    ...
    : 'function' == typeof define && define.amd
      ? define('libphonenumber', [], t)
      : 'object' == typeof exports
        ? (exports.libphonenumber = t())
        : (d.libphonenumber = t());
})(window, function () {
  return (function (d) {
    var t = {};
    ...
    return (
      ...
      ($.c = t),
      ($.d = function (d, t, e) {
        $.o(d, t) || Object.defineProperty(d, t, { configurable: !1, enumerable: !0, get: e });
      }),
      ($.r = function (d) {
    ...
    function (d, t, $) {
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        (t.extractCountryCallingCode = function (d, t, $) {
          ...
          for (; r - 1 <= s && r <= d.length; ) {
            var i = d.slice(1, r);
            if ($.countryCallingCodes()[i]) return { countryCallingCode: i, number: d.slice(r) };
            r++;
          }
          return {};
        }),
      ...
      var e,
        n = $(10),
        r = $(5),
        a = (e = r) && e.__esModule ? e : { default: e };
      var i = (t.WHITESPACE = '  ­​⁠　'),
    ...
    function (d, t, $) {
      ...
      (t.validateMetadata = _),
        (t.getExtPrefix = function (d, t) {
        ...
        l = (function () {
          function d(t) {
            u(this, d),
              ...
              (this.metadata = t),
              (this.v1 = !t.version),
              (this.v2 = void 0 !== t.version && -1 === (0, a.default)(t.version, s)),
              (this.v3 = void 0 !== t.version);
          }
          return (
            o(d, [
              {
      ...
      function _(d) {
        ...
        if (!p(d) || !p(d.countries) || (!p(d.country_calling_codes) && !p(d.country_phone_code_to_countries)))
          throw new Error(
            "[libphonenumber-js] `metadata` argument was passed but it's not a valid metadata. Must be an object having `.countries` and `.country_calling_codes` child object properties. Got " +
              (p(d) ? 'an object of shape: { ' + Object.keys(d).join(', ') + ' }' : 'a ' + y(d) + ': ' + d) +
              '.'
          );
      }
      var p = function (d) {
    ...
    function (d, t, $) {
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        (t.default = function (d, t, $, o) {
          var s = (function (d, t, $, e) {
              ...
              'string' == typeof t
                ? e
                  ? ((a = l({ defaultCountry: t }, $)), (i = e))
                  : ((a = { defaultCountry: t }), (i = $))
                : $
                  ? ((a = t), (i = $))
                  : (i = t);
              a = a ? l({}, g, a) : g;
              return { text: n, options: a, metadata: new r.default(i) };
            })(d, t, $, o),
            c = s.text,
            h = s.options,
            p = s.metadata;
          if (h.defaultCountry && !p.hasCountry(h.defaultCountry))
            throw new Error('Unknown country: ' + h.defaultCountry);
          var y = (function (d) {
              ...
              var $ = (function (d) {
                ...
                var e = d.match(_),
                  n = 1;
                for (; n < e.length; ) {
                  if (null != e[n] && e[n].length > 0) return { number: $, ext: e[n] };
                  n++;
                }
              })(t);
              if ($.ext) return $;
          ...
          var b = (function (d, t, $) {
              var r = (0, e.extractCountryCallingCode)(d, t, $),
                ...
                u = r.number;
              if (!u) return { countryCallingCode: o };
              var s = void 0;
              ...
              var l = (function (d, t) {
                  ...
                  if (t.possibleLengths())
                    switch ((0, i.check_number_length_for_type)(o, void 0, t)) {
                      case 'TOO_SHORT':
                      case 'INVALID_LENGTH':
                        break;
                      default:
                    ...
                    ((0, e.matches_entirely)($, t.nationalNumberPattern()) &&
                      !(0, e.matches_entirely)(o, t.nationalNumberPattern())) ||
                      (($ = o), (r = u));
                  return { national_number: $, carrier_code: r };
                })(u, $),
                f = l.national_number,
                c = l.carrier_code,
                h = x(o, f, $);
              h && ((s = h), $.country(s));
              return { country: s, countryCallingCode: o, national_number: f, carrierCode: c };
        ...
        (t.is_viable_phone_number = C),
        (t.extract_formatted_phone_number = P),
        (t.strip_national_prefix_and_carrier_code = I),
        (t.find_country_code = x);
      var e = $(0),
        n = s($(5)),
        r = s($(1)),
        a = s($(9)),
      ...
      var l =
        ...
        g = { country: {} };
      function C(d) {
        return d.length >= f && (0, e.matches_entirely)(d, m);
      }
      function P(d) {
        if (d && !(d.length > c)) {
          var t = d.search(v);
      ...
      function I(d, t) {
        ...
        var $ = new RegExp('^(?:' + t.nationalPrefixForParsing() + ')'),
          e = $.exec(d);
        if (!e) return { number: d };
        var n = void 0,
          r = e.length - 1;
        n =
          t.nationalPrefixTransformRule() && e[r]
            ? d.replace($, t.nationalPrefixTransformRule())
            : d.slice(e[0].length);
        var a = void 0;
        return r > 0 && (a = e[1]), { number: n, carrierCode: a };
      }
      function x(d, t, $) {
        ...
        return 1 === e.length
          ...
          : (function (d, t, $) {
              ...
              for (var e = d, n = Array.isArray(e), a = 0, e = n ? e : e[Symbol.iterator](); ; ) {
                ...
                } else if ((0, o.default)({ phone: t, country: u }, $.metadata)) return u;
              }
            })(e, t, $.metadata);
      }
    },
    function (d, t, $) {
      ...
      (t.default = function (d, t, $) {
        ...
        (t.is_of_type = l),
        (t.sort_out_arguments = f),
        (t.check_number_length_for_type = function (d, t, $) {
          var e = $.type(t),
      ...
      function l(d, t, $) {
        return (
          ...
          (0, a.matches_entirely)(d, t.pattern())
        );
      }
      function f(d, t, $) {
        var e = void 0,
        ...
        if ('string' == typeof d)
          'string' == typeof t || void 0 === t
            ? ((a = $), (0, n.is_viable_phone_number)(d) && (e = (0, r.default)(d, t, a)))
            : ((a = t), (0, n.is_viable_phone_number)(d) && (e = (0, r.default)(d, a)));
        else {
          if (!c(d) || 'string' != typeof d.phone)
        ...
        return { input: e, metadata: new i.default(a) };
      }
      var c = function (d) {
          ...
          return function (d, t) {
            ...
            if (Symbol.iterator in Object(d))
              return (function (d, t) {
                ...
                try {
                  for (
                    var a, i = d[Symbol.iterator]();
                    !(e = (a = i.next()).done) && ($.push(a.value), !t || $.length !== t);
                    e = !0
                  );
                } catch (d) {
                  (n = !0), (r = d);
    ...
    function (d, t, $) {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 }), (t.FIRST_GROUP_PATTERN = void 0);
      var e =
        'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator
          ? function (d) {
              return typeof d;
      ...
      (t.default = function (d, t, $, e, n) {
        var i = (function (d, t, $, e, n) {
            var r = void 0,
              ...
              u = void 0;
            if ('string' == typeof d)
              if ('string' == typeof $) (r = { phone: d, country: t }), (a = $), n ? ((i = e), (u = n)) : (u = e);
              else {
                if (((r = { phone: d }), 'string' != typeof t))
                  throw new Error('Format type argument not passed for `format()`');
                (a = t), e ? ((i = $), (u = e)) : (u = $);
              }
            else {
              if (!m(d) || 'string' != typeof d.phone)
                throw new TypeError(
            ...
            i = i ? l({}, f, i) : f;
            return { input: r, format_type: a, options: i, metadata: new o.default(u) };
          })(d, t, $, e, n),
          s = i.input,
          c = i.format_type,
          h = i.options,
        ...
        switch (c) {
          case 'International':
            return C
              ? ((C = _(C, 'International', !1, p)),
                v((C = '+' + p.countryCallingCode() + ' ' + C), s.ext, p, h.formatExtension))
              : '+' + p.countryCallingCode();
          case 'E.164':
            return '+' + p.countryCallingCode() + s.phone;
          case 'RFC3966':
            return (0, u.formatRFC3966)({ number: '+' + p.countryCallingCode() + s.phone, ext: s.ext });
          case 'IDD':
            ...
            if (h.humanReadable) {
              ...
              return v(
                (C = I || P + ' ' + p.countryCallingCode() + ' ' + _(C, 'International', !1, p)),
                s.ext,
                p,
                h.formatExtension
              );
          ...
          case 'National':
            return C ? v((C = _(C, 'National', !1, p)), s.ext, p, h.formatExtension) : '';
        }
      }),
        (t.format_national_number_using_format = h),
        (t.choose_format_for_number = p),
        (t.local_to_international_style = y),
        (t.formatIDDSameCountryCallingCodeNumber = b);
      var n,
        r = $(0),
        a = $(10),
        i = $(1),
      ...
      function h(d, t, $, e, n) {
        var r = new RegExp(t.pattern()),
          a =
            ...
            (t.nationalPrefixFormattingRule() && t.nationalPrefixIsOptionalWhenFormatting() && !e);
      ...
      function b(d, t, $, e) {
        ...
        if ((n.country($), t === n.countryCallingCode()))
          return '1' === t ? t + ' ' + _(d, 'National', !1, e) : _(d, 'National', !1, e);
      }
    },
    function (d, t, $) {
      'use strict';
    ...
    function (d, t, $) {
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        (t.getIDDPrefix = function (d, t) {
          var $ = new r.default(t);
          if (($.country(d), (0, a.matches_entirely)($.IDDPrefix(), o))) return $.IDDPrefix();
    ...
    function (d) {
      d.exports = {
        ...
        countries: {
          ...
          AF: ['93', '00', '[2-7]\\d{8}', [9], [['([2-7]\\d)(\\d{3})(\\d{4})', '$1 $2 $3', ['[2-7]']]], '0', '0$1'],
          AG: [
            '1',
            '011',
            '(?:268|[58]\\d\\d|900)\\d{7}',
          ...
          AO: ['244', '00', '[29]\\d{8}', [9], [['(\\d{3})(\\d{3})(\\d{3})', '$1 $2 $3']]],
          AR: [
            '54',
            '00',
            '(?:11|(?:[2368]|9\\d)\\d)\\d{8}',
          ...
          AT: [
            '43',
            '00',
            '[1-35-9]\\d{8,12}|4(?:[0-24-9]\\d{4,11}|3(?:[05]\\d{3,10}|[2-467]\\d{3,4}|8\\d{3,6}|9\\d{3,7}))|[1-35-8]\\d{7}|[1-35-7]\\d{5,6}|[15]\\d{4}|1\\d{3}',
          ...
          AW: ['297', '00', '(?:[25-79]\\d\\d|800)\\d{4}', [7], [['(\\d{3})(\\d{4})', '$1 $2']]],
          AX: [
            '358',
            '00|99(?:[01469]|5(?:11|3[23]|41|5[59]|77|88|9[09]))',
            '1\\d{5,11}|(?:[27]|4\\d)\\d{4,9}|[356]0\\d{6,8}|800\\d{4,7}|[35]0\\d{4,5}',
            [5, 6, 7, 8, 9, 10, 11, 12],
            [
          ...
          BF: ['226', '00', '[25-7]\\d{7}', [8], [['(\\d{2})(\\d{2})(\\d{2})(\\d{2})', '$1 $2 $3 $4']]],
          BG: [
            '359',
            '00',
          ...
          BI: ['257', '00', '(?:[267]\\d|31)\\d{6}', [8], [['(\\d{2})(\\d{2})(\\d{2})(\\d{2})', '$1 $2 $3 $4']]],
          ...
          BL: [
            ...
            0,
            0,
            [['590(?:2[7-9]|5[12]|87)\\d{4}'], ['69(?:0\\d{2}|1(?:2[29]|3[0-5]))\\d{4}']]
          ],
          BM: [
            '1',
            '011',
          ...
          BN: ['673', '00', '[2-578]\\d{6}', [7], [['([2-578]\\d{2})(\\d{4})', '$1 $2', ['[2-578]']]]],
          BO: [
            '591',
            '00(1\\d)?',
            '(?:[2-467]\\d{3}|80017)\\d{4}',
          ...
          CF: ['236', '00', '(?:[27]\\d{3}|8776)\\d{4}', [8], [['(\\d{2})(\\d{2})(\\d{2})(\\d{2})', '$1 $2 $3 $4']]],
          CG: [
            '242',
            '00',
            '(?:(?:0\\d|80)\\d|222)\\d{6}',
          ...
          CI: ['225', '00', '[02-8]\\d{7}', [8], [['(\\d{2})(\\d{2})(\\d{2})(\\d{2})', '$1 $2 $3 $4']]],
          CK: ['682', '00', '[2-8]\\d{4}', [5], [['(\\d{2})(\\d{3})', '$1 $2']]],
          CL: [
            '56',
          ...
          CV: ['238', '0', '[2-59]\\d{6}', [7], [['(\\d{3})(\\d{2})(\\d{2})', '$1 $2 $3']]],
          CW: [
            '599',
            '00',
            '(?:[34]1|60|(?:7|9\\d)\\d)\\d{5}',
          ...
          CY: ['357', '00', '(?:[279]\\d|[58]0)\\d{6}', [8], [['(\\d{2})(\\d{6})', '$1 $2']]],
          CZ: [
            '420',
            '00',
          ...
          DJ: ['253', '00', '(?:2\\d|77)\\d{6}', [8], [['(\\d{2})(\\d{2})(\\d{2})(\\d{2})', '$1 $2 $3 $4']]],
          DK: ['45', '00', '[2-9]\\d{7}', [8], [['(\\d{2})(\\d{2})(\\d{2})(\\d{2})', '$1 $2 $3 $4']]],
          DM: [
            '1',
            '011',
            '(?:[58]\\d\\d|767|900)\\d{7}',
          ...
          EH: [
            ...
            [
              ...
              [
                '([58]\\d{3})(\\d{5})',
                '$1-$2',
                ['5(?:2[2-489]|3[5-9]|92)|892', '5(?:2(?:[2-48]|9[0-7])|3(?:[5-79]|8[0-7])|924)|892']
              ],
          ...
          ER: ['291', '00', '[178]\\d{6}', [7], [['(\\d)(\\d{3})(\\d{3})', '$1 $2 $3']], '0', '0$1'],
          ES: [
            '34',
            '00',
            '(?:51|[6-9]\\d)\\d{7}',
          ...
          FK: ['500', '00', '[2-7]\\d{4}', [5]],
          FM: ['691', '00', '[39]\\d{6}', [7], [['(\\d{3})(\\d{4})', '$1 $2']]],
          FO: ['298', '00', '(?:[2-8]\\d|90)\\d{4}', [6], [['(\\d{6})', '$1']], 0, 0, '(10(?:01|[12]0|88))'],
          FR: [
            '33',
            '00',
            '[1-9]\\d{8}',
          ...
          GF: ['594', '00', '[56]94\\d{6}', [9], [['(\\d{3})(\\d{2})(\\d{2})(\\d{2})', '$1 $2 $3 $4']], '0', '0$1'],
          GG: [
            '44',
            '00',
          ...
          GI: ['350', '00', '(?:[25]\\d|62)\\d{6}', [8], [['(\\d{3})(\\d{5})', '$1 $2', ['2']]]],
          GL: ['299', '00', '(?:19|[2-689]\\d)\\d{4}', [6], [['(\\d{2})(\\d{2})(\\d{2})', '$1 $2 $3']]],
          ...
          GY: ['592', '001', '(?:(?:(?:[2-46]\\d|77)\\d|862)\\d|9008)\\d{3}', [7], [['(\\d{3})(\\d{4})', '$1 $2']]],
          HK: [
            '852',
            '00(?:[126-9]|30|5[09])?',
          ...
          HN: ['504', '00', '[237-9]\\d{7}', [8], [['(\\d{4})(\\d{4})', '$1-$2']]],
          HR: [
            '385',
            '00',
          ...
          HT: ['509', '00', '[2-489]\\d{7}', [8], [['(\\d{2})(\\d{2})(\\d{4})', '$1 $2 $3']]],
          HU: [
            '36',
            '00',
            '[2357]\\d{8}|[1-9]\\d{7}',
          ...
          IL: [
            '972',
            '0(?:0|1[2-9])',
            '1\\d{6}(?:\\d{3,5})?|[57]\\d{8}|[1-489]\\d{7}|[2-689]\\d{3}',
            [4, 7, 8, 9, 10, 11, 12],
            [
          ...
          KM: ['269', '00', '[3478]\\d{6}', [7], [['(\\d{3})(\\d{2})(\\d{2})', '$1 $2 $3']]],
          KN: [
            '1',
            '011',
            '(?:[58]\\d\\d|900)\\d{7}',
          ...
          KR: [
            ...
            '(?:00(?:0\\d|[1-9]\\d{1,4})|(?:[13-6]\\d|2)\\d?|70\\d|80)\\d{7}|1\\d{7}|[3-6]\\d{4,5}',
          ...
          LS: ['266', '00', '(?:[256]\\d\\d|800)\\d{5}', [8], [['(\\d{4})(\\d{4})', '$1 $2']]],
          LT: [
            '370',
            '00',
            '(?:[3469]\\d|52|[78]0)\\d{6}',
          ...
          LV: ['371', '00', '(?:[268]\\d|90)\\d{6}', [8], [['([2689]\\d)(\\d{3})(\\d{3})', '$1 $2 $3', ['[2689]']]]],
          LY: [
            '218',
            '00',
            '(?:[2569]\\d|71)\\d{7}',
          ...
          MF: [
            ...
            0,
            0,
            [['590(?:0[079]|13|2[79]|30|43|5[0-268]|7[79]|87)\\d{4}'], ['69(?:0\\d{2}|1(?:2[29]|3[0-5]))\\d{4}']]
          ],
          MG: [
            '261',
            '00',
          ...
          MH: ['692', '011', '(?:(?:[256]\\d|45)\\d|329)\\d{4}', [7], [['(\\d{3})(\\d{4})', '$1-$2']], '1'],
          MK: [
            '389',
            '00',
            '[2-578]\\d{7}',
          ...
          MO: ['853', '00', '(?:28|[68]\\d)\\d{6}', [8], [['([268]\\d{3})(\\d{4})', '$1 $2', ['[268]']]]],
          MP: [
            '1',
            '011',
            '(?:[58]\\d\\d|(?:67|90)0)\\d{7}',
          ...
          MT: ['356', '00', '(?:(?:[2579]\\d\\d|800)\\d|3550)\\d{4}', [8], [['(\\d{4})(\\d{4})', '$1 $2']]],
          MU: [
            '230',
            '0(?:0|[2-7]0|33)',
            '(?:[2-468]|5\\d)\\d{6}',
          ...
          NC: ['687', '00', '[2-57-9]\\d{5}', [6], [['(\\d{2})(\\d{2})(\\d{2})', '$1.$2.$3', ['[2-46-9]|5[0-4]']]]],
          NE: [
            '227',
            '00',
            '[0289]\\d{7}',
          ...
          NI: ['505', '00', '(?:1800|[25-8]\\d{3})\\d{4}', [8], [['(\\d{4})(\\d{4})', '$1 $2']]],
          NL: [
            '31',
            '00',
            '(?:[124-7]\\d\\d|3(?:[02-9]\\d|1[0-8]))\\d{6}|(?:8\\d|9[01])\\d{5,8}|1\\d{4,5}',
            [5, 6, 7, 8, 9, 10],
            [
          ...
          NR: ['674', '00', '(?:444|55\\d|888)\\d{4}', [7], [['(\\d{3})(\\d{4})', '$1 $2']]],
          NU: ['683', '00', '(?:[47]|888\\d)\\d{3}', [4, 7], [['(\\d{3})(\\d{4})', '$1 $2', ['888']]]],
          NZ: [
            '64',
            '0(?:0|161)',
          ...
          PM: ['508', '00', '[45]\\d{5}', [6], [['([45]\\d)(\\d{2})(\\d{2})', '$1 $2 $3', ['[45]']]], '0', '0$1'],
          PR: [
            '1',
            '011',
            '(?:[589]\\d\\d|787)\\d{7}',
          ...
          PW: ['680', '01[12]', '(?:[25-8]\\d\\d|345|488|900)\\d{4}', [7], [['(\\d{3})(\\d{4})', '$1 $2']]],
          PY: [
            '595',
            '00',
          ...
          SB: ['677', '0[01]', '(?:[1-6]|[7-9]\\d\\d)\\d{4}', [5, 7], [['(\\d{2})(\\d{5})', '$1 $2', ['[7-9]']]]],
          SC: [
            '248',
            '0(?:[02]|10?)',
          ...
          SD: ['249', '00', '[19]\\d{8}', [9], [['(\\d{2})(\\d{3})(\\d{4})', '$1 $2 $3']], '0', '0$1'],
          SE: [
            '46',
            '00',
            '(?:[26]\\d\\d|9)\\d{9}|[1-9]\\d{8}|[1-689]\\d{7}|[1-4689]\\d{6}|[27]\\d{5}',
            [6, 7, 8, 9, 10],
            [
              [
                '([1-469]\\d)(\\d{3})(\\d{2})',
          ...
          SH: [
            ...
            0,
            0,
            [['2(?:[0-57-9]\\d|6[4-9])\\d{2}'], ['[56]\\d{4}', [5]], 0, 0, 0, 0, 0, 0, ['262\\d{2}', [5]]]
          ],
          SI: [
            '386',
            '00',
          ...
          SL: ['232', '00', '(?:[2-578]\\d|66|99)\\d{6}', [8], [['(\\d{2})(\\d{6})', '$1 $2']], '0', '(0$1)'],
          SM: [
            '378',
            '00',
            '(?:0549|[5-7]\\d)\\d{6}',
          ...
          SS: ['211', '00', '[19]\\d{8}', [9], [['(\\d{3})(\\d{3})(\\d{3})', '$1 $2 $3', 0, '0$1']], '0'],
          ...
          TA: ['290', '00', '8\\d{3}', [4], 0, 0, 0, 0, 0, 0, 0, [['8\\d{3}']]],
          TC: [
            '1',
            '011',
            '(?:[58]\\d\\d|649|900)\\d{7}',
          ...
          TN: ['216', '00', '[2-57-9]\\d{7}', [8], [['(\\d{2})(\\d{3})(\\d{3})', '$1 $2 $3']]],
          TO: [
            '676',
            '00',
          ...
          UG: [
            ...
            [
              [
                '(\\d{3})(\\d{6})',
                '$1 $2',
                ['20[0-8]|4(?:6[45]|[7-9])|[7-9]', '20(?:[013-8]|2[5-9])|4(?:6[45]|[7-9])|[7-9]']
              ],
          ...
          VE: ['58', '00', '(?:(?:[24]\\d|50)\\d|[89]00)\\d{7}', [10], [['(\\d{3})(\\d{7})', '$1-$2']], '0', '0$1'],
          VG: [
            '1',
            '011',
            '(?:284|[58]\\d\\d|900)\\d{7}',
          ...
          VN: [
            '84',
            '00',
            '[12]\\d{9}|(?:[19]\\d|8[0-35-9])\\d{7}|1\\d{7}|69\\d{5,6}|(?:[18]\\d\\d|799)\\d{4}',
            [7, 8, 9, 10],
            [
              ['([17]99)(\\d{4})', '$1 $2', ['[17]99']],
          ...
          VU: [
            '678',
            '00',
            '(?:(?:[23]|[57]\\d\\d|900)\\d|[48]8)\\d{3}',
            [5, 7],
            [['(\\d{3})(\\d{4})', '$1 $2', ['[579]']]]
          ],
          WF: ['681', '00', '(?:[45]0|68|72|8\\d)\\d{4}', [6], [['(\\d{2})(\\d{2})(\\d{2})', '$1 $2 $3']]],
          WS: [
            '685',
            '0',
    ...
    function (d, t, $) {
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        (t.strip_dangling_braces = g),
        (t.cut_stripping_dangling_braces = C),
        (t.close_dangling_braces = function (d, t) {
          var $ = d.slice(0, t),
            e = P('(', $),
            n = P(')', $),
            r = e - n;
        ...
        b = (function () {
          function d(t, $) {
            !(function (d, t) {
              ...
              (this.options = {}),
              (this.metadata = new e.default($)),
              t && this.metadata.hasCountry(t) && (this.default_country = t),
              this.reset();
          }
          return (
            s(d, [
              {
                ...
                value: function (d) {
                  ...
                  return (
                    t || (d && d.indexOf('+') >= 0 && (t = '+')),
                    (0, n.matches_entirely)(t, v) ? this.process_input((0, o.default)(t)) : this.current_output
                  );
                }
              },
              {
                ...
                value: function (d) {
                  if (
                    ('+' === d[0] &&
                      (this.parsed_input || ((this.parsed_input += '+'), this.reset_countriness()), (d = d.slice(1))),
                    (this.parsed_input += d),
                    (this.national_number += d),
                    ...
                    (this.national_number = this.national_prefix + this.national_number),
                      ...
                      this.national_prefix !== t &&
                        ((this.matching_formats = this.available_formats), this.reset_format());
                  }
              ...
              },
              {
                ...
                value: function () {
                  return this.is_international() && this.countryCallingCode
                    ? this.national_number
                      ? ((this.template =
                          c + I(c, this.countryCallingCode.length) + ' ' + I(c, this.national_number.length)),
                        '+' + this.countryCallingCode + ' ' + this.national_number)
              ...
              },
              {
                ...
                value: function () {
                  var d = this.national_number,
                    t = d.length - 3;
                  t < 0 && (t = 0),
                    (this.matching_formats = this.matching_formats.filter(function ($) {
              ...
              },
              {
                ...
                value: function () {
                  ...
                  for (d = t ? d : d[Symbol.iterator](); ; ) {
                    ...
                    var n = e;
                    if (
                      new RegExp('^(?:' + n.pattern() + ')$').test(this.national_number) &&
                      this.is_format_applicable(n)
                    ) {
                      this.reset_format(), (this.chosen_format = n);
                      var r = (0, a.format_national_number_using_format)(
                        this.national_number,
                        n,
                        this.is_international(),
                  ...
                  if (((this.national_prefix = ''), this.metadata.selectedCountry())) {
                    ...
                    if (
                      (this.metadata.possibleLengths() &&
                        (!this.is_possible_number(this.national_number) || this.is_possible_number(d))) ||
                      !(0, n.matches_entirely)(this.national_number, this.metadata.nationalNumberPattern()) ||
                      (0, n.matches_entirely)(d, this.metadata.nationalNumberPattern())
                    )
                      return (
                        (this.national_prefix = this.national_number.slice(0, this.national_number.length - d.length)),
                        (this.national_number = d),
                        this.national_prefix
                      );
                  }
              ...
              },
              {
                ...
                value: function () {
                  ...
                  for (d = t ? d : d[Symbol.iterator](); ; ) {
                    ...
                    if (this.is_format_applicable(n) && this.create_formatting_template(n))
                      return (this.chosen_format = n), (this.last_match_position = -1), !0;
                  }
              ...
              },
              {
                ...
                value: function (d) {
                  return !(
                    !this.is_international() &&
                    !this.national_prefix &&
                    d.nationalPrefixIsMandatoryWhenFormatting()
                  );
                }
              },
              {
                ...
                value: function (d) {
                  if (!(d.pattern().indexOf('|') >= 0)) {
                    ...
                    if (t)
                      return (
                        (this.partially_populated_template = t),
                        this.is_international()
                          ? (this.template = c + I(c, this.countryCallingCode.length) + ' ' + t)
                          : (this.template = t.replace(/\d/g, c)),
                        this.template
                      );
                  }
                }
              ...
              },
              {
                ...
                value: function (d) {
                  ...
                  for (t = $ ? t : t[Symbol.iterator](); ; ) {
                    ...
                    var r = n;
                    if (-1 === this.partially_populated_template.slice(this.last_match_position + 1).search(h))
                      return (
                        (this.chosen_format = void 0),
                        (this.template = void 0),
                        void (this.partially_populated_template = void 0)
                      );
                    (this.last_match_position = this.partially_populated_template.search(h)),
                      (this.partially_populated_template = this.partially_populated_template.replace(h, r));
                  }
              ...
              },
              {
                ...
                value: function (d) {
                  return this.is_international()
                    ? (0, a.local_to_international_style)(d.internationalFormat())
                    : !d.nationalPrefixFormattingRule() || (!this.national_prefix && d.usesNationalPrefix())
                      ? d.format()
                      : d.format().replace(a.FIRST_GROUP_PATTERN, d.nationalPrefixFormattingRule());
                }
              },
              {
    ...
    function (d, t, $) {
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        (t.searchPhoneNumbers = function (d, t, $, e) {
          ...
          return (function (d, t, $) {
            t in d
              ? Object.defineProperty(d, t, { value: $, enumerable: !0, configurable: !0, writable: !0 })
              : (d[t] = $);
            return d;
          })({}, Symbol.iterator, function () {
            return {
              next: function () {
                return o.hasNext() ? { done: !1, value: o.next() } : { done: !0 };
              }
            };
          });
        }),
        ...
        return (
          l(d, [
            ...
            },
            {
              ...
              value: function (d, t) {
                if (
                  (0, i.default)(d, t, this.text) &&
                  (0, o.default)(d, t, this.text, this.options.extended ? 'POSSIBLE' : 'VALID')
                ) {
              ...
              value: function () {
                return (
                  'NOT_READY' === this.state &&
                    ((this.last_match = this.find()), this.last_match ? (this.state = 'READY') : (this.state = 'DONE')),
                  'READY' === this.state
                );
              }
            },
      ...
      function y(d, t, $, e) {
        ...
        return (
          ...
          'string' == typeof t
            ? e
              ? ((a = s({ defaultCountry: t }, $)), (i = e))
              : ((a = { defaultCountry: t }), (i = $))
            : $
              ? ((a = t), (i = $))
              : (i = t),
          a || (a = {}),
          { text: r, options: a, metadata: new n.default(i) }
        );
      }
    },
    function (d, t) {
    ...
    function (d, t, $) {
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        (t.DIGIT_PLACEHOLDER =
          t.AsYouTypeCustom =
          t.getCountryCallingCodeCustom =
          t.getNumberTypeCustom =
          t.PhoneNumberSearchCustom =
          t.searchPhoneNumbersCustom =
          t.findPhoneNumbersCustom =
          t.isValidNumberCustom =
          t.formatCustom =
          t.parseCustom =
          t.DIGITS =
          t.Metadata =
      ...
      Object.defineProperty(t, 'AsYouTypeCustom', {
        ...
        (t.getCountryCallingCode = x),
        (t.getPhoneCode = function (d) {
          return x(d);
        }),
      ...
      (P.prototype = Object.create(o.PhoneNumberSearch.prototype, {})),
        (P.prototype.constructor = P),
        (I.prototype = Object.create(v.default.prototype, {})),
