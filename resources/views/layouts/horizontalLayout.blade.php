            ...
            <ul class="gdz-sidebar nav nav-tabs" role="tablist">
              <div class="gdz-sidebar-content">
                ...
                <li class="nav-item mt-10">
                  <a href="{{ route('page-dashboard') }}" @class([ 'nav-link' , 'active'=> Route::currentRouteName() ===
                    'page-dashboard',
                    ])>
                ...
                <li class="nav-item">
                  <a href="{{ route('page-strategy-packs') }}" @class([ 'nav-link' , 'active'=>
                    Route::currentRouteName() === 'page-strategy-packs',
                    ])>
                ...
                <li class="nav-item">
                  <a href="{{ route('page-algorithms') }}" @class([ 'nav-link' , 'active'=> Route::currentRouteName()
                    === 'page-algorithms',
                    ])>
                    <svg width="20" height="20" viewBox="0 0 314 314" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                ...
                <li class="nav-item">
                  <a href="{{ route('page-transactions') }}" @class([ 'nav-link' , 'active'=> Route::currentRouteName()
                    === 'page-transactions',
                    ])>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                      <path fill="currentColor"
                ...
                <li class="nav-item mt-10 d-none">
                  <button type="button" class="nav-link">
                    <svg width="24" height="24" viewBox="0 0 500 500" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <defs>
                        <linearGradient id="paint0_linear_1015_79" x1="250" y1="0" x2="250" y2="500"
