    ...
    <div class="{{ $containerNav }}">
      ...
      <div class="gdz-navbar navbar-nav-right d-flex align-items-center" id="navbar-collapse">
        <ul class="navbar-nav nav-pills flex-row align-items-center ms-auto gap-2">
          <li class="nav-item">
            <button type="button" class="btn btn-sm text-gray border-0" data-bs-toggle="modal"
                    ...
                    <table class="table card-table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <span>{{ number_format($wallet['balance'] * $marketDataPrices[$wallet['wallet']], 2)
                              }}$</span>
                          </td>
                        </tr>
                        @endforeach
            ...
            <ul class="dropdown-menu dropdown-menu-end dropdown-user">
              ...
              <li>
                <a class="dropdown-item" href="{{ route('page-user-profile') }}">
                  <svg class="me-3" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                    <circle cx="12" cy="6" r="4" fill="currentColor" />
                    <path fill="currentColor"
                      d="M20 17.5c0 2.485 0 4.5-8 4.5s-8-2.015-8-4.5S7.582 13 12 13s8 2.015 8 4.5" opacity=".5" />
                  </svg>
