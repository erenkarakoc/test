...
@section('page-style')
  @vite(['resources/assets/vendor/scss/pages/team.scss', 'resources/assets/vendor/scss/_components/_transaction-modal.scss'])
@endsection

@section('page-script')
  @vite(['resources/assets/js/pages/team.js', 'resources/assets/js/ui-popover.js', 'resources/assets/js/components/transaction-modal.js'])
@endsection
