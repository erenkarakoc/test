              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex align-items-center justify-content-between">
                    ...
                    <button type="button" class="strategy-pack-btn" data-index="{{ $loop->index }}"
                      data-title="{{ $strategyPack->title }}"
                      data-algorithms="{{ json_encode($allStrategyAlgorithms) }}">
        ...
        <div class="card bg-light border">
          <div class="card-body">
            ...
            <small class="d-flex align-items-start text-primary gap-2 mt-4">
              ...
              <span>
                After locking up the pack, asset/assets selected by you will be swapped to locked USD.
              </span>
            </small>
            ...
            <small class="d-flex align-items-start text-primary gap-2 mt-4">
              ...
              <span>
                Above specified amounts are estimated values and may vary at the end of the lock period
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column">
                      <div class="d-flex align-items-center">
                        ...
                        <small class="algorithms-table-contribution-rate">≈{{ $algorithm->profit_contribution
                          }}%</small>
                        <span class="popover-trigger text-light cursor-pointer lh-1 ms-1 mb-1" data-bs-html="true"
                          data-bs-toggle="popover" data-bs-trigger="hover" data-bs-placement="top"
                ...
                <td>
                  ...
                  @elseif (collect(json_decode($strategyPacks->where('title',
                  'Momentum')->first()->algorithms))->contains($algorithm->title))
                  <div class="d-flex justify-content-center">
                    <span class="text-primary">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                        <path fill="currentColor"
                ...
                <td>
                  ...
                  @elseif (collect(json_decode($strategyPacks->where('title',
                  'Scalper')->first()->algorithms))->contains($algorithm->title))
                  <div class="d-flex justify-content-center">
                    <span class="text-primary">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                        <path fill="currentColor"
                ...
                <td>
                  ...
                  @elseif (collect(json_decode($strategyPacks->where('title',
                  'Swift')->first()->algorithms))->contains($algorithm->title))
                  <div class="d-flex justify-content-center">
                    <span class="text-primary">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                        <path fill="currentColor"
