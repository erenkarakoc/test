...
@vite(['resources/assets/vendor/libs/flatpickr/flatpickr.scss', 'resources/assets/vendor/libs/swiper/swiper.scss',
'resources/assets/vendor/libs/toastr/toastr.scss'])
@endsection

@section('vendor-script')
@vite(['resources/assets/vendor/libs/flatpickr/flatpickr.js', 'resources/assets/vendor/libs/swiper/swiper.js',
              ...
              <div class="col-12">
                <div class="d-flex justify-content-between">
                  <div class="h6 d-flex align-items-center text-white mb-0">
                    ...
                    <small class="fw-medium ms-2 strategy-pack-text-bg" data-bs-toggle="popover" data-bs-trigger="hover"
  ...
  <div class="nav-tabs-shadow nav-align-left row mt-12" id="algorithms-nav">
      ...
      <div id="left-sidebar">
        ...
        <div class="d-flex flex-column row-gap-2 mt-4">
          <button type="button" class="btn btn-sm btn-label-primary rounded w-100 justify-content-start text-left"
            ...
            <svg class="me-2 ms-2" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24">
              <path fill="currentColor"
    ...
    <div class="col col-md-4">
      <div class="tab-content pt-0 ps-0">
        ...
        <div class="tab-pane fade show active" id="basic" role="tabpanel" aria-labelledby="basic" tabindex="0">
                    ...
                    <div class="d-flex flex-column w-100">
                      <h5 class="d-flex justify-content-between w-100 text-heading mb-1 fw-bold lh-1">
                        ...
                        <div class="d-flex align-items-center">
                          ...
                          <span class="algorithm-contribution">≈<span>{{ number_format($algorithm->profit_contribution,
                              2) }}</span>%</span>
                        </div>
                      </h5>
              ...
              <table class="table">
                <tbody class="table-border-bottom-0">
                  ...
                  <tr>
                    ...
                    <td class="text-end"><span class="text-white" id="total_amount_after_unlock_percentage">0.00%</span>
                    </td>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <div class="d-flex">
            <svg class="me-3 flex-shrink-0 text-primary" width="50" height="50" viewBox="0 0 32 32" fill="none"
              xmlns="http://www.w3.org/2000/svg">
              <path opacity="0.6"
                ...
                <div class="card-body mt-2">
                  ...
                  <ul class="list-group mt-4">
                    <li class="list-group-item d-flex align-items-center">
                      <svg class="me-1 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        viewBox="0 0 24 24">
                        <path fill="currentColor"
                          d="M12 22c-4.714 0-7.071 0-8.536-1.465C2 19.072 2 16.714 2 12s0-7.071 1.464-8.536C4.93 2 7.286 2 12 2s7.071 0 8.535 1.464C22 4.93 22 7.286 22 12s0 7.071-1.465 8.535C19.072 22 16.714 22 12 22"
                          opacity=".5"></path>
                    ...
                    <li class="list-group-item d-flex align-items-center">
                      <svg class="me-1 flex-shrink-0" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path opacity="0.5" fill-rule="evenodd" clip-rule="evenodd"
                          d="M2.00007 11.5L2 12C2 12.3458 2 12.679 2.00058 13C2.00788 17.0552 2.1074 19.1793 3.464 20.535C4.929 22 7.286 22 12 22C16.714 22 19.072 22 20.535 20.535C21.8925 19.1784 21.9921 17.055 21.9994 13C22 12.679 22 12.3458 22 12L21.9999 11.5C21.9981 7.11753 21.9473 4.87723 20.535 3.464C19.071 2 16.714 2 12 2C7.286 2 4.93 2 3.464 3.464C2.0527 4.87626 2.0019 7.11746 2.00007 11.5ZM2.00007 11.5L2.00058 13H21.9994L21.9999 11.5H2.00007Z"
                          fill="currentColor" />
