              ...
              <div class="d-flex justify-content-between">
                <div class="d-flex align-items-center mb-0">
                  <svg width="34" height="34" viewBox="0 0 500 500" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <defs>
                      <linearGradient id="paint0_linear_1015_77" x1="250" y1="15" x2="250" y2="485"
            ...
            <div class="transaction-item transaction-item-in" data-tnx-id="{{ $transaction->tnx_id }}">
              <div class="d-flex align-items-start">
                <div class="transaction-item-icon">
                  ...
                  <svg class="text-danger" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg"
                    fill="none">
                    <path opacity="0.5"
...
@endforeach
              ...
              <div class="d-flex align-items-center">
                <div class="d-flex flex-column align-items-end text-right">
                  ...
                  <span class="transaction-asset-amount text-light">{{ formatBalance($transaction->amount_in_asset) }}
                    {{ $transaction->asset }}</span>
                </div>
                <span class="transaction-item-view">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
