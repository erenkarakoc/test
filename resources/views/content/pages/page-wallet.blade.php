...
@vite(['resources/assets/vendor/libs/apex-charts/apexcharts.scss', 'resources/assets/vendor/libs/select2/select2.scss',
...
@vite(['resources/assets/vendor/libs/apex-charts/apexcharts.js', 'resources/assets/vendor/libs/select2/select2.js',
'resources/assets/vendor/libs/bootstrap-select/bootstrap-select.js', 'resources/assets/vendor/libs/toastr/toastr.js',
...
@section('page-script')
@vite(['resources/assets/js/pages/wallet.js', 'resources/assets/js/helpers/gdzhelpers.js',
      ...
      <div
        ...
        <div class="p-4">
          <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex flex-column align-items-end text-right">
              <h5 class="mb-0 text-white">
                {{ number_format($userBalances->where('wallet', 'USDT')->value('balance') * $marketDataPrices['USDT'],
                2) }}$
              </h5>
              <small class="text-dark">
                ...
                <div class="d-flex justify-content-between align-items-center">
                  ...
                  <div class="d-flex flex-column align-items-end text-right">
                    ...
                    <small class="text-light">
                      {{ $wallet['wallet'] === 'GDZ' ? formatBalance($wallet['balance']) :
            ...
            <div class="card bg-light wallet-item wallet-item-{{ $wallet['wallet'] }}">
              <div class="p-4 pb-0">
                <div class="d-flex justify-content-between align-items-center">
                  ...
                  <div class="d-flex flex-column align-items-end text-right">
                    <h5 class="mb-1 lh-1" data-asset="{{ $wallet['wallet'] }}" data-asset-balance={{
        ...
        <div class="col-12 mt-7">
          <div class="d-flex justify-content-between align-items-center bg-light p-4 rounded">
            <div class="d-flex align-items-center">
              <svg class="text-primary me-2 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                viewBox="0 0 24 24">
              ...
              <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                  ...
                  <button type="button" class="btn btn-sm btn-icon btn-transparent toggle-manage-modal-button"
                    data-bs-toggle="modal" data-bs-target="#manageWalletModal" data-bs-target="#manageWalletModal"
                    data-id="{{ $walletItem['id'] }}" data-symbol="{{ $walletItem['symbol'] }}"
                    data-title="{{ $walletItem['title'] }}" data-active="{{ $walletItem['active'] ? 'true' : 'false' }}"
              ...
              <div class="card-body">
                <div class="d-flex flex-column justify-content-center align-items-center text-center">
                  ...
                  <p>Please {{ $inactiveWallets->count() ? 'activate' : 'add' }} a wallet in order to
                    cash-out.</p>
                  <button type="button" class="addWalletModalToggle btn btn-sm btn-primary mt-3" data-bs-toggle="modal"
                ...
                <div class="d-flex justify-content-between align-items-center">
                  <label class="form-label d-flex align-items-center mb-0"
                    ...
                    <div class="d-flex flex-column">
                      ...
                      <small class="text-light">
                        {{ $walletItem['symbol'] }}&nbsp;{{ $walletItem['symbol'] === 'ETH' || $walletItem['symbol'] ===
                        'ETC' ? '(ERC-20)' : '' }}{{ $walletItem['symbol'] === 'USDT' || $walletItem['symbol'] === 'TRX'
                        ? '(TRC-20)' : '' }}
                      </small>
                    </div>
                  </label>
        ...
        <div class="row mt-12">
          <div class="d-flex flex-column row-gap-2">
            <small class="d-flex align-items-center text-primary gap-2">
              <svg class="flex-shrink-0" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                <path fill="currentColor"
              ...
              <div class="card-body">
                <div class="d-flex align-items-center justify-content-between">
                  ...
                  <div class="d-flex flex-column text-end">
                    <span class="h6 mb-0">{{ number_format(
                      $userBalances->where('wallet', $asset->symbol)->value('balance') *
                      $marketDataPrices[$asset->symbol],
                      2,
                      ) }}$</span>
                    <small class="text-light">{{ formatBalance($userBalances->where('wallet',
                      $asset->symbol)->value('balance')) }}
                      {{ $asset->symbol }}</small>
                  </div>
                </div>
                ...
                <div class="d-flex align-items-center">
                  <div class="wallet-address-wrapper w-100 mt-1" data-bs-toggle="popover" data-bs-trigger="hover"
                    ...
                    <input type="text" class="wallet-address" value="{{ $walletAddresses[$asset->symbol]['address'] }}"
                  ...
                  <button type="button" class="wallet-address-toggle-btn btn btn-icon border ms-2"
                    data-bs-toggle="modal" data-bs-target="#walletDetailModal" data-account-data="{{ json_encode([
                              'title' => $asset->title,
                              'symbol' => $asset->symbol,
          ...
          <div class="row">
            <div class="col-4 add-wallet-form-row">
              ...
              <select id="addWalletAssetSelect" class="selectpicker w-100" data-style="btn-default" name="symbol">
                ...
                &&isset($walletAddresses[$asset->symbol]['address']))
            ...
            <div class="col-8 add-wallet-form-row">
              ...
              <div class="input-group required">
                ...
                <button class="btn btn-label-primary border border-primary px-3" type="button" id="addWalletPasteButton"
                  style="border-right-color: var(--bs-primary) !important;">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                    <path fill="currentColor"
            ...
            <div class="col-12 mt-6 add-wallet-form-row">
              ...
              <div class="input-group">
                <input type="text" class="form-control rounded" placeholder="eg. Personal" aria-label="eg. Personal"
                  id="addModalAssetLabel" name="label" data-existing-labels="{{ implode(', ', $existingLabels) }}" />
              </div>
            </div>
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-12 manage-wallet-form-row mt-6">
              ...
              <div class="input-group">
                <input type="text" class="form-control rounded" placeholder="eg. Personal" aria-label="eg. Personal"
                  id="manageModalAssetLabel" name="label" data-existing-labels="{{ implode(', ', $existingLabels) }}" />
              </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="col col-12">
              ...
              <div class="wallet-address-wrapper w-100 mt-1" data-bs-toggle="popover" data-bs-trigger="hover"
                data-bs-placement="top" data-bs-custom-class="popover-dark wallet-address-popover"
                data-bs-content="Click to copy">
                <input type="text" class="wallet-address" value="" readonly id="walletAccountModalAddress" />
                <span class="wallet-address-copy">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    <path fill="currentColor"
                      d="M6.6 11.397c0-2.726 0-4.089.843-4.936c.844-.847 2.201-.847 4.917-.847h2.88c2.715 0 4.073 0 4.916.847c.844.847.844 2.21.844 4.936v4.82c0 2.726 0 4.089-.844 4.936c-.843.847-2.201.847-4.916.847h-2.88c-2.716 0-4.073 0-4.917-.847s-.843-2.21-.843-4.936z" />
      ...
      <form class="modal-content" id="sendFundsForm">
          ...
          <div class="row">
            ...
            <div class="col col-12">
              ...
              <div class="wallet-address-wrapper w-100 mt-1">
                <input type="text" class="wallet-address" value="" readonly id="sendFundsModalAddressInput">
              </div>
            </div>
            <div class="col col-12">
              <div class="form-text mt-2">
        ...
        <div class="modal-footer d-flex justify-content-center mt-6">
          ...
          <button type="submit" class="btn btn-sm btn-primary px-6" id="sendFundsSubmitButton" disabled>
            <svg class="loading-hidden" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24">
