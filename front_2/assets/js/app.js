...
document.addEventListener("DOMContentLoaded", function () {
   ...
   */
  const sidebarMenuList = document.querySelectorAll(
    ".doc-sidebar-menu__list li"
  )
   ...
   */
  const testimonialSliderThree = document.querySelector(
  ...
  if (window.matchMedia(lgScreen).matches) {
    ...
    animateLine3d.forEach((item) => {
      ...
      const animateLine3dSplitted = new SplitText(item, {
    ...
    animateTextFromRight.forEach((item) => {
      ...
      const animateTextFromRightSplitted = new SplitText(item, {
        type: "chars, words, lines",
      })
    ...
    animateTextFromLeft.forEach((item) => {
      ...
      const animateTextFromLeftSplitted = new SplitText(item, {
        type: "chars, words, lines",
      })
     ...
     */
    const animateTextFromBottom = gsap.utils.toArray(
      ".animate-text-from-bottom"
    )
    animateTextFromBottom.forEach((item) => {
      ...
      const animateTextFromBottomSplitted = new SplitText(item, {
        type: "chars, words, lines",
      })
    ...
    animateTextFromTop.forEach((item) => {
      ...
      const animateTextFromTopSplitted = new SplitText(item, {
        type: "chars, words, lines",
      })
    ...
    fadeIn(
      ".fadein_bottom_12",
      { opacity: 0, y: 100, duration: 3, delay: 0.5 },
      { stagger: 0.25 }
    )
    ...
    fadeIn(
      ".fadein_1",
      { opacity: 0, duration: 2, delay: 0.25 },
      { stagger: 0.25 }
    )
    fadeIn(
      ".fadein_2",
    ...
    heroOne.forEach((element) => {
      ...
      tl.fromTo(
        ...
        { y: 0 },
        { y: 50, yoyo: true, repeat: -1, duration: 3 }
      )
      tl.fromTo(
        ".hero-1-shapes__img--6",
        { y: 0 },
        { y: 20, yoyo: true, repeat: -1, duration: 2.5 },
        "<"
      )
    })
  }
